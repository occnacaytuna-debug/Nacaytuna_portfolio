...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ensure skills scroll starts at the first card on mobile
    const skillsCards = document.querySelector('.skills-cards');
    if (skillsCards && window.innerWidth <= 768) {
        skillsCards.style.scrollBehavior = 'auto';
        skillsCards.scrollLeft = 0;
